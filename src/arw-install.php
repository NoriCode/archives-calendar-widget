...
function _archivesCalendar_activate() {
	...
	$default_options = array(
		"category_filter"  => 0, // filter the archives pages to display only the widget selected categories
		"default_theme"    => "calendrier", // the default theme to use for the widget
		"display_settings" => 1, // will display Setting of the plugin in the admin side menu
		"enqueue_css"      => 1, // enqueue the CSS to the theme
		"version"          => ARCWV // current version of the plugin installed
	);
